-- EcoAgadir - Données de démo (à exécuter après schema.sql)
-- Les utilisateurs sont créés par le backend au premier login.
...
('pl2', CURDATE(), 'matin', 'u3', 'c2', 'd1', 'dec1', '{"distance_totale": 19.2, "duree_estimee": 150}', 'planifie', NULL, NULL, 0),
